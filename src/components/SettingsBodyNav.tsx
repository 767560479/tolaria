import { Article, ArrowsClockwise as RefreshCw, Cube, GitBranch, Images, ListChecks, Palette, Robot as Bot, ShieldCheck, type IconProps } from '@phosphor-icons/react'
...
export function SettingsBodyNav({ t }: SettingsBodyNavProps) {
  const items: SettingsNavItem[] = [
    ...
    { id: SETTINGS_SECTION_IDS.gallery, label: t('settings.gallery.title'), Icon: Images },
