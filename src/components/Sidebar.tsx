...
type SidebarTagsNavigationProps = Pick<
  SidebarNavigationProps,
  | 'loading'
  | 'entries'
  | 'selection'
...
function SidebarTagsNavigation({
  loading,
  entries,
  selection,
  onSelect,
...
function SidebarFavoritesAndTagsNavigation(props: SidebarNavigationProps) {
  return (
    <>
...
function SidebarNavigation(props: SidebarNavigationProps) {
  return (
    <nav className="flex-1 overflow-y-auto">
      <SidebarFavoritesAndTagsNavigation {...props} />
      ...
      <SidebarFoldersNavigation
        ...
        toggleGroup={props.toggleGroup}
        locale={props.locale}
        allNotesFileVisibility={props.allNotesFileVisibility}
  ...
  return (
    <aside className="flex h-full flex-col overflow-hidden border-r border-[var(--sidebar-border)] bg-sidebar text-sidebar-foreground">
      <SidebarTitleBar
        ...
        onFindInVault={props.onFindInVault}
