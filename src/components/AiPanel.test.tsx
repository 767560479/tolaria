...
describe('AiPanel', () => {
  ...
  it('renders panel with chat mode header', () => {
    render(<AiPanel onClose={vi.fn()} vaultPath="/tmp/vault" />)
    expect(screen.getByText('AI Agent')).toBeTruthy()
    expect(screen.getByText('Claude Code · Chat')).toBeTruthy()
    expect(screen.getByText('Chat mode can use note context, but it does not get vault-write tools or shell access.')).toBeTruthy()
  })
