...
function isSameTagSelection(a: Extract<SidebarSelection, { kind: 'tag' }>, b: Extract<SidebarSelection, { kind: 'tag' }>) {
  return a.tag === b.tag
}
...
export function selectionsEqual(a: SidebarSelection, b: SidebarSelection): boolean {
  ...
  switch (a.kind) {
    ...
    case 'tag':
      return isSameTagSelection(a, b as Extract<SidebarSelection, { kind: 'tag' }>)
  }
}
