...
const STATIC_LABEL_KEYS: Partial<Record<string, TranslationKey>> = {
  ...
  'duplicate-note': 'command.note.duplicateNote',
  'close-other-tabs': 'command.note.closeOtherTabs',
  'close-all-tabs': 'command.note.closeAllTabs',
...
function localizeSettingsStateCommand(): string | null {
  return null
}
