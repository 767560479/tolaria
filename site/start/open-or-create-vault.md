...
On Windows, you can right-click a `.md` file in Explorer, choose **Open with** → **Tolaria**, and Tolaria opens that file’s parent folder in a **separate window** and selects the note. Your existing Tolaria window and vault stay unchanged; closing the new window returns you to them. Git is optional for that folder.
